...
// const reviews = [
//   {id:1, name:'Олена', text:'Ремонт виконано швидко і якісно! Дуже задоволена результатом.', img:'/images/client1.jpg'},
//   {id:2, name:'Андрій', text:'Чудова команда! Зробили все під ключ і без зайвого клопоту.', img:'/images/client2.jpg'},
//   {id:3, name:'Марина', text:'Ідеальний дизайн інтер’єру, дякую BuildPro!', img:'/images/client3.jpg'}
// ];
...
//                   <div className="testimonial-card col-md-8">
//                     <div className="d-flex align-items-center gap-3 mb-2">
//                       <img src={r.img} alt={r.name} style={{width:64,height:64,objectFit:'cover',borderRadius:8}} />
//                       <div>
